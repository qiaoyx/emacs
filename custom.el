 ...
 '(org-latex-listings-langs
   (quote
    ((emacs-lisp "Lisp")
     ...
     (R "r")
     (haskell "haskell"))))
 '(org-latex-packages-alist (quote (("" "tikz-cd" nil))))
 ...
 '(preview-default-preamble
   (quote
    ("\\RequirePackage["
     ...
     "]{preview}[2004/11/05]" "\\\\PreviewEnvironment{tikzpicture}" "\\\\PreviewEnvironment{tikz-cd}")))
 '(preview-inner-environments
   (quote
    ("Bmatrix" "Vmatrix" "aligned" "array" "bmatrix" "cases" "gathered" "matrix" "pmatrix" "smallmatrix" "split" "subarray" "vmatrix" "tikzcd")))
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:family "NSimSun" :foundry "ZYEC" :slant normal :weight normal :height 143 :width normal))))
